...
if __name__ == "__main__":
    ...
    logs_folder = os.path.join('logs', f"{current_datetime}_{args.dataset}_{args.n_pred * 5}min_ray-semi-dec-gossip-learning")
    ...
    for cln_actor in cln_actors:
        cln_actor.test_2d_data.remote(master_zscore, args)
