...
def get_parameters():
    ...
    parser.add_argument('--end_of_initial_data_index', type=int, default=29792, help='End of initial data for training dataset (model will train using datapoints 0-end_of_initial_data_index from all sensors) (METR-LA default: 16491) (PeMS-BAY default: 29692) (PeMSD7-M default: 4537)')
...
if __name__ == "__main__":
    ...
    logs_folder = os.path.join('logs', f"{current_datetime}_{args.dataset}_pred-{args.n_pred * 5}min_his-{args.n_his * 5}min_ray-semi-dec-server-free-fl-distance_online-training_with-distribution-adaptive-node-score")
