...
def get_parameters():
    ...
    parser.add_argument('--end_of_initial_data_index', type=int, default=29692, help='End of initial data for training dataset (model will train using datapoints 0-end_of_initial_data_index from all sensors) (METR-LA default: 16491) (PeMS-BAY default: 29692) (PeMSD7-M default: 4537)')
    parser.add_argument('--data_per_step', type=int, default=300, help='How much data will be taken from entire training dataset each "epoch" (each time model will be trained) (METR-LA default: 250) (PeMS-BAY default: 300) (PeMSD7-M default: 140)')
...
def cloudlet_train(args, cln_actors, cln_models, zscore, len_train, num_nodes, device):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for cln_actor in cln_actors:
            ray.get(cln_actor.choose_cross_cloudlet_nodes_by_distribution.remote(args.stblock_num, args.Ks, num_nodes, device, args.n_his, args.n_pred, args.batch_size, epoch, zscore))
...
if __name__ == "__main__":
    ...
    logs_folder = os.path.join('logs', f"{current_datetime}_{args.dataset}_pred-{args.n_pred * 5}min_his-{args.n_his * 5}min_ray-semi-dec-gossip-learning-distance_online-training_with-distribution-adaptive-node-score")
