...
def data_preparate(args, device):
    ...
    return cln_adj_matrix, cln_train_list, len_train, train_iters, x_train, y_train, val_iters, test_iters, cln_edge_index_list, cln_node_map_list, master_zscore
...
def cloudlet_train(args, cln_actors, cln_models, zscore, len_train):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for cln_actor in cln_actors:
            cln_done.append(cln_actor.log_validation_metric_for_online_training.remote(epoch, zscore, num_epochs))
...
if __name__ == "__main__":
    ...
    logs_folder = os.path.join('logs', f"{current_datetime}_{args.dataset}_pred-{args.n_pred * 5}min_his-{args.n_his * 5}min_ray-semi-dec-server-free-fl-distance_online-training")

    cln_adj_matrix, cln_train_list, len_train, train_iters, x_trains, y_trains, val_iters, test_iters, cln_edge_index_list, cln_node_map_list, master_zscore = data_preparate(args, device)
