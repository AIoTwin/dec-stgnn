...
def get_parameters():
    ...
    parser.add_argument('--data_per_step', type=int, default=70, help='How much data will be taken from entire training dataset each "epoch" (each time model will be trained) (METR-LA default: 250) (PeMS-BAY default: 300) (PeMSD7-M default: 140)')
